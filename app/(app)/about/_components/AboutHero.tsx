...
export default function AboutHero() {
  return (
    <section className="min-h-[80vh] relative overflow-hidden bg-[linear-gradient(160deg,#060b1a_0%,#0c1733_30%,#0f2050_60%,#1e3a8a_100%)] flex items-center px-8 pt-30 pb-20 max-[768px]:px-5 max-[768px]:pt-25 max-[768px]:pb-15">
      ...
      <div className="max-w-300 mx-auto w-full grid grid-cols-1 md:grid-cols-2 gap-18 max-[960px]:gap-12 items-center relative z-1">
        <div className="animate-slide-in-left">
          <div className="inline-flex items-center gap-2 rounded-full px-4 py-1.75 mb-6 relative overflow-hidden isolate bg-white/8 backdrop-blur-sm before:content-[''] before:absolute before:-inset-11.25 before:rounded-[80px] before:bg-[conic-gradient(from_0deg,transparent_0%,transparent_80%,#60a5fa_88%,#93c5fd_92%,#60a5fa_96%,transparent_100%)] before:animate-border-rotate before:z-[-2] after:content-[''] after:absolute after:inset-[1.5px] after:rounded-full after:bg-[rgba(8,14,36,0.85)] after:backdrop-blur-sm after:z-[-1]">
          ...
          <p className="text-white/70 text-[17px] leading-[1.75] mb-9 max-w-115">
          ...
          <div className="flex gap-3 flex-wrap">
            ...
            <a
              href="#contact"
              className="h-13 px-7 bg-white/8 text-white border-[1.5px] border-white/20 rounded-xl text-[15px] font-bold cursor-pointer no-underline inline-flex items-center backdrop-blur-sm transition-colors duration-200 hover:bg-white/[.14]"
            >
              Hubungi Kami
            </a>
          </div>
        ...
        <div className="order-first md:order-0 animate-[slideInRight_0.7s_ease_0.1s_both]">
          <div className="bg-white/5 backdrop-blur-[20px] border border-white/12 rounded-3xl p-9 animate-float-y shadow-[0_24px_64px_rgba(0,0,0,0.35)]">
