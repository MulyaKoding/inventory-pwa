export default function AboutContact() {
  return (
    ...
    >
      <div className="max-w-300 mx-auto bg-[linear-gradient(145deg,#060b1a,#0c1733,#1e3a8a)] rounded-[28px] px-16 py-18 max-[960px]:px-9 max-[960px]:py-12 grid grid-cols-1 md:grid-cols-2 gap-16 max-[960px]:gap-10 items-center relative overflow-hidden">
        ...
        <div className="relative z-1">
          <div className="inline-flex items-center gap-2 bg-white/12 rounded-full px-3.5 py-1.25 mb-4">
        ...
        <div className="relative z-1 flex flex-col gap-3.5">
          ...
          <a
            ...
            className="flex items-center gap-4 bg-black/20 backdrop-blur-md border border-white/10 rounded-2xl px-6 py-5 no-underline transition-[background,border-color,transform] duration-200 hover:bg-black/32 hover:border-white/22 hover:translate-x-1"
          >
