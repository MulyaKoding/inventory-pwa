export default function AboutContact() {
  return (
    <section
      id="contact"
      className="px-8 pb-25 max-[768px]:px-5 max-[768px]:pb-18 bg-[#060b1a] text-white"
    >
      <div className="max-w-300 mx-auto bg-[linear-gradient(145deg,#0b1328,#0f172a,#060b1a)] border border-white/10 rounded-[28px] px-16 py-18 max-[960px]:px-9 max-[960px]:py-12 grid grid-cols-1 md:grid-cols-2 gap-16 max-[960px]:gap-10 items-center relative overflow-hidden shadow-[0_20px_50px_rgba(0,0,0,0.5)]">
        ...
        <div className="relative z-1">
          <div className="inline-flex items-center gap-2 bg-brand-500/15 border border-white/10 rounded-full px-3.5 py-1.25 mb-4">
          ...
          <p className="text-white/65 text-[15px] leading-[1.75] mb-2">
        ...
        <div className="relative z-1 flex flex-col gap-3.5">
          ...
          <a
            ...
            className="flex items-center gap-4 bg-white/5 backdrop-blur-md border border-white/10 rounded-2xl px-6 py-5 no-underline transition-[background,border-color,transform] duration-200 hover:bg-white/10 hover:border-brand-400 hover:translate-x-1"
          >
            ...
            <div>
              <div className="text-[10px] font-bold text-white/45 uppercase tracking-[0.07em] mb-1">
                WhatsApp
              </div>
