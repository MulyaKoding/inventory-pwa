...
export default function HomeAnalyticsSection() {
  return (
    <section className="px-8 py-25 bg-[#070d19] text-white">
      <div className="max-w-300 mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-8 items-center [direction:ltr]">
          ...
          <div className="md:order-1 relative rounded-3xl overflow-hidden shadow-[0_24px_64px_rgba(0,0,0,.5)] border border-white/10 animate-slide-in-up group">
            <img
              src={IMG2}
            ...
            <div className="absolute bottom-5 left-5 bg-[#0f172a]/90 border border-white/10 backdrop-blur-md rounded-xl px-4 py-3 shadow-[0_8px_24px_rgba(0,0,0,.5)]">
              <div className="font-black text-xl text-brand-400">Real-Time</div>
